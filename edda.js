...
$(document).ready(function (e) {
  ...
  mWidth = app.clientWidth - horizontalPadding;
  mHeight = app.clientHeight - verticalPadding;
  app = $("#editorApp");
});
function calcSize() {
  app = $("#editorApp");
  mWidth = app.width() - horizontalPadding;
  mHeight = app.height() - verticalPadding;
  var div = document.getElementById("viewerid");
  var div2 = document.getElementById("printDimensionsWrap");

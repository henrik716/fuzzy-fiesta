...
$(document).ready(function(e) {
    var lbutton = document.getElementsByClassName("yikes-easy-mc-submit-button-2")[0];
    if(typeof lbutton === undefined || lbutton == null) {
        lbutton = document.getElementsByClassName("yikes-easy-mc-submit-button-3")[0];
    }
    if(lbutton != null) {
...
function validateEmail(id)
{
    ...
    if(!email_regex.test($("#" + id).val()))
    {
        ...
        div.append('<span id="glypcn' + id + '" class="glyphicon glyphicon-remove danger form-control-feedback">eMail-Adresse ungÃ¼ltig</span>');
        emailFine = false;
        return false;
    }
    else {
...
function saveA() {
    ...
    a.email = email;
    a = JSON.stringify(a);
    $.post("../wp-content/plugins/editor-designer/save.php", {
        data: a,
        sendmail: true,
        language: lang
    }, function(result) {

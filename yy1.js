...
function goToTab() {
  $("div[data-toggle='collapse']").each(function () {
    if ($(this).attr("value") == navBar) {
      $(this).removeClass("collapsed");
      $("#" + $(this).attr("value") + "_desktop").addClass("show");
    } else {
      $(this).removeClass("collapsed");
      $(this).addClass("collapsed");
      $("#" + $(this).attr("value") + "_desktop").removeClass("show");
    }
  });
...
$(document).ready(function (e) {
  ...
  mWidth = mc.clientWidth - horizontalPadding;
  mHeight = mc.clientHeight - verticalPadding;
  mc = $("#mapContainer");
});
function calcSize() {
  mc = $("#mapContainer");
  mWidth = mc.width() - horizontalPadding;
  mHeight = mc.height() - verticalPadding;
  var div = document.getElementById("mapID");
  var div2 = document.getElementById("measurmentsWrap");
  if (mapHeight < mHeight && mapWidth < mWidth) {
    ...
    if (mapHeight < mHeight) {
      ...
      var e = mWidth / mapWidth;
      var t = mHeight / mapHeight;
      if (e < t) {
        scale = e;
      } else {
        scale = t;
